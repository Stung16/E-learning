...
const Front_end_Development = () => {
  return (
    <section className='max-w-[1920px] w-[100%] p-0 my-0 mx-auto'>
      <div className='mb-[60px] px-11 pt-2 pb-0 '>
        <div className='mb-20 '>
          ...
          <div className='max-w-[840px] break-words text-[#292929] text-[15px] leading-[24px]'>
            ...
            <p className='my-[6px] mx-0'>
            Tại Việt Nam, 
             <strong><a className='text-[#f05123] underline' href=""> lương trung bình </a></strong>  cho lập trình viên front-end vào khoảng 
          ...
          <section className='min-[1113px]:mx-[-12px] min-[740px]:mx-[-8px] flex flex-wrap'>
            <section className='min-[1113px]:w-[66.66667%] min-[1113px]:block min-[1113px]:px-3 min-[740px]:w-[100%] min-[740px]:block min-[740px]:px-[-8px]'>
                    ...
                    <div className='border-[2px] border-solid border-[#e8e8e8] rounded-[16px] my-4 mx-0 p-6'>
                      <div className='flex'>
                        <div className='min-w-[228px] relative'>
                          <a href="">
                            <img className='rounded-[16px] w-[228px] h-[142px]' src="https://files.fullstack.edu.vn/f8-prod/courses/7.png" alt="Kiến Thức Nhập Môn IT" />
                          </a>
                        </div>
                         <div className='flex-1 ml-6'>
                          ...
                          <a className='bg-[#f05123] text-[#fff] appearance-none border border-solid border-[#f05123] rounded-[999px] inline-block text-[14px] font-semibold text-center whitespace-nowrap select-none py-[8px] px-[20px] opacity-100 hover:opacity-95' href="">
                            Tiếp tục học
                          </a>
                         </div>
                      </div>
                  ...
                  <div>
                    <div className='border-[2px] border-solid border-[#e8e8e8] rounded-[16px] my-4 mx-0 p-6'>
                      <div className='flex'>
                        <div className='min-w-[228px] relative'>
                          <a href="">
                            <img className='rounded-[16px] w-[228px] h-[142px]' src="https://files.fullstack.edu.vn/f8-prod/courses/15/62f13d2424a47.png" alt="Kiến Thức Nhập Môn IT" />
                            <div className='bg-[#0000004d] rounded-[8px] absolute left-[12px] pt-[2px] pl-[5px] pr-[10px] pb-[2px] pointer-events-none top-[12px] w-[27px]'>
                            <i className="w-[16px] text-[#FFD43B] fa-solid fa-crown"></i>
                            </div>
                          </a>
                        </div>
                         <div className='flex-1 ml-6'>
                          <h2 className='text-[18px] font-bold m-0'>
                            ...
                            <span className='text-[16px] text-[#f05123] font-semibold'>1.299.000đ</span>
                            </div>
                            </a>
                          </h2>
                          <div className='mt-[6px]'></div>
                      ...
                      <div>
                        ...
                        <div className='ml-5'>
                          <div>
                            <div className='flex flex-row rounded-[16px] gap-[20px] pt-5 pr-5 pb-0 pl-0'>
                              <a href="">
                                <div className='min-w-[126px] pt-[56%] relative'>
                                  <img className='rounded-[10px] h-[100%] inset-0 object-cover absolute w-[100%]' src="https://files.fullstack.edu.vn/f8-prod/courses/2.png" alt="HTML CSS từ Zero đến Hero" />
                                </div>
                              </a>
                              <div className='flex-1'>
                                ...
                                <p className='break-words text-[12px] leading-[14px] my-2 mx-0 overflow-hidden'>
                  ...
                  <div>
                    <div className='border-[2px] border-solid border-[#e8e8e8] rounded-[16px] my-4 mx-0 p-6'>
                      <div className='flex'>
                        <div className='min-w-[228px] relative'>
                          <a href="">
                            <img className='rounded-[16px] w-[228px] h-[142px]' src="https://files.fullstack.edu.vn/f8-prod/courses/1.png" alt="Kiến Thức Nhập Môn IT" />
                          </a>
                        </div>
                         <div className='flex-1 ml-6'>
                          <h2 className='text-[18px] font-bold m-0'>
                    ...
                    <div className='border-[2px] border-solid border-[#e8e8e8] rounded-[16px] my-4 mx-0 p-6'>
                      <div className='flex'>
                        <div className='min-w-[228px] relative'>
                          <a href="">
                            <img className='rounded-[16px] w-[228px] h-[142px]' src="https://files.fullstack.edu.vn/f8-prod/courses/12.png" alt="Kiến Thức Nhập Môn IT" />
                          </a>
                        </div>
                         <div className='flex-1 ml-6'>
                          <h2 className='text-[18px] font-bold m-0'>
                  ...
                  <div>
                    <div className='border-[2px] border-solid border-[#e8e8e8] rounded-[16px] my-4 mx-0 p-6'>
                      <div className='flex'>
                        <div className='min-w-[228px] relative'>
                          <a href="">
                            <img className='rounded-[16px] w-[228px] h-[142px]' src="https://files.fullstack.edu.vn/f8-prod/courses/14/624faac11d109.png" alt="Kiến Thức Nhập Môn IT" />
                          </a>
                        </div>
                         <div className='flex-1 ml-6'>
                          <h2 className='text-[18px] font-bold m-0'>
                  ...
                  <div>
                    <div className='border-[2px] border-solid border-[#e8e8e8] rounded-[16px] my-4 mx-0 p-6'>
                      <div className='flex'>
                        <div className='min-w-[228px] relative'>
                          <a href="">
                            <img className='rounded-[16px] w-[228px] h-[142px]' src="https://files.fullstack.edu.vn/f8-prod/courses/13/13.png" alt="Kiến Thức Nhập Môn IT" />
                          </a>
                        </div>
                         <div className='flex-1 ml-6'>
                          <h2 className='text-[18px] font-bold m-0'>
                            <a className='text-[#333] ' href="">
                            Xây Dựng Wwebsite với ReactJS
                            <span className='text-[#f05123] block text-[16px] font-semibold mt-[2px]'>Miễn phí</span>
                            </a>
                          </h2>
                          <div className='mt-[6px]'></div>
              ...
              <div>
                ...
                <i className="text-[#FFD43B] text-[20px] ml-2  fa-solid fa-crown"></i>
                </h2>
                <p className='text-[14px] leading-[22px]'>
                ...
                <div className='mt-5 mx-auto mb-0'>
                  <section className='flex flex-wrap min-[1113px]:mx-[-12px] min-[740px]:mx-[-8px]'>
                    <section className='min-[1113px]:w-[33.33333%] min-[1113px]:block min-[1113px]:px-3 min-[740px]:w-[50%] min-[740px]:px-[-8px] min-[740px]:block'>
                      <div className='rounded-[16px] flex flex-col mb-[30px]'>
                        <a href="">
                          <div className='h-[100%] pt-[56%] relative group'>
                            <img className='inset-0 object-cover absolute rounded-[16px] h-[100%] w-[100%]' src="https://files.fullstack.edu.vn/f8-prod/courses/15/62f13d2424a47.png" alt="" />
                            <div className='bg-[#0000004d] rounded-[8px] pt-[2px] pb-[3px] pl-[5px] pointer-events-none absolute top-[12px] left-[11px] w-[27px] z-[1]'>
                            <i className="text-[#FFD43B] fa-solid fa-crown"></i>
                            </div>
                        ...
                        <div>
                          <h2 className='text-[18px] font-bold my-[6px] mx-0'>
                            <a className='text-[#333]' href="">HTML CSS Pro</a>
                          </h2>
                          <div>
                            <span className='text-[14px] mr-2 line-through'>2.500.000đ</span>
                    ...
                    <section className='min-[1113px]:w-[33.33333%] min-[1113px]:block min-[1113px]:px-3 min-[740px]:w-[50%] min-[740px]:px-[-8px] min-[740px]:block'>
                      <div className='rounded-[16px] flex flex-col mb-[30px]'>
                        <a href="">
                          <div className='h-[100%] pt-[56%] relative group'>
                            <img className='inset-0 object-cover absolute rounded-[16px] h-[100%] w-[100%]' src="https://files.fullstack.edu.vn/f8-prod/courses/27/64e184ee5d7a2.png" alt="" />
                            <div className='bg-[#0000004d] rounded-[8px] pt-[2px] pb-[3px] pl-[5px] pointer-events-none absolute top-[12px] left-[11px] w-[27px] z-[1]'>
                            <i className="text-[#FFD43B] fa-solid fa-crown"></i>
                            </div>
                            <button className='btn-seeMore group-hover:top-1/2 group-hover:visible group-hover:opacity-100'>Xem khóa học</button>
                        ...
                        <div>
                          <h2 className='text-[18px] font-bold my-[6px] mx-0'>
                            <a className='text-[#333]' href="">Ngôn ngữ tiền xử lý Sass</a>
                          </h2>
                          <div>
                    ...
                    <section className='min-[1113px]:w-[33.33333%] min-[1113px]:block min-[1113px]:px-3 min-[740px]:w-[50%] min-[740px]:px-[-8px] min-[740px]:block'>
                      <div className='rounded-[16px] flex flex-col mb-[30px]'>
                        <a href="">
                          <div className='h-[100%] pt-[56%] relative group'>
                            <img className='inset-0 object-cover absolute rounded-[16px] h-[100%] w-[100%]' src="https://files.fullstack.edu.vn/f8-prod/courses/19/62f13cb607b4b.png" alt="" />
                            <div className='bg-[#0000004d] rounded-[8px] pt-[2px] pb-[3px] pl-[5px] pointer-events-none absolute top-[12px] left-[11px] w-[27px] z-[1]'>
                            <i className="text-[#FFD43B] fa-solid fa-crown"></i>
                            </div>
                        ...
                        <div>
                          <h2 className='text-[18px] font-bold my-[6px] mx-0'>
                            <a className='text-[#333]' href="">JavaScript Pro</a>
                          </h2>
                          <div>
                    ...
                    <section className='min-[1113px]:w-[33.33333%] min-[1113px]:block min-[1113px]:px-3 min-[740px]:w-[50%] min-[740px]:px-[-8px] min-[740px]:block'>
                      <div className='rounded-[16px] flex flex-col mb-[30px]'>
                        <a href="">
                          <div className='h-[100%] pt-[56%] relative group'>
                            <img className='inset-0 object-cover absolute rounded-[16px] h-[100%] w-[100%]' src="https://files.fullstack.edu.vn/f8-prod/courses/20/648020fc16597.png" alt="" />
                            <div className='bg-[#0000004d] rounded-[8px] pt-[2px] pb-[3px] pl-[5px] pointer-events-none absolute top-[12px] left-[11px] w-[27px] z-[1]'>
                            <i className="text-[#FFD43B] fa-solid fa-crown"></i>
                            </div>
                        ...
                        <div>
                          <h2 className='text-[18px] font-bold my-[6px] mx-0'>
                            <a className='text-[#333]' href="">NextJS Pro</a>
                          </h2>
                          <div>
            ...
            <div className='sticky top-[80px] flex justify-end '>
              <div className='flex flex-col max-w-[300px] pl-[2px]'>
                <a className='mt-[32px]' href="">
                  <img className='max-w-[100%] w-[100%] rounded-lg object-cover opacity-100 hover:opacity-80' src="https://files.fullstack.edu.vn/f8-prod/banners/22/63dc5f7e5562c.png" alt="" />
                </a>
                <a className='mt-[32px]' href="">
