  ...
  return (
    <section className="max-w-[1920px] w-[100%] p-0 my-0 mx-auto">
      <div className="DefaultLayout_container mb-[60px] px-11 pt-2 pb-0 ">
        <div className="mb-20 ">
          <h1 className="text-[#242424] text-[28px] font-black my-[19px]">
          ...
          <div className="max-w-[840px] break-words text-[#292929] text-[15px] leading-[24px]">
            <p className="my-[6px] mx-0">
              ...
              thấy và có thể tương tác, đó chính là các ứng dụng mobile hay
              những website bạn đã từng sử dụng. Vì vậy, nhiệm vụ của lập trình
            ...
            <p className="my-[6px] mx-0">
              Dưới đây là các khóa học F8 đã tạo ra dành cho bất cứ ai theo đuổi
        ...
        <div>
          <section className="min-[1113px]:mx-[-12px] min-[740px]:mx-[-8px] flex flex-wrap">
            <section className="index-module FE min-[1113px]:w-[66.66667%] min-[1113px]:block min-[1113px]:px-3 min-[740px]:w-[100%] min-[740px]:block min-[740px]:px-[-8px]">
              <div>
                <h2 className="text-[#242424] text-[24px] font-black">
                    ...
                    <div className="border-[2px] border-solid border-[#e8e8e8] rounded-[16px] my-4 mx-0 p-6">
                      <div className="CourseItem_inner flex flex-wrap">
                        <div className="min-w-[228px] relative">
                          <div
                            onClick={() => {
                              if (idCourseLearned?.includes(5)) {
                                return navigate(
                                  `/learning/kien-thuc-nhap-mon-it?id=1`
                                );
                              } else {
                                return navigate(
                                  `/courses/kien-thuc-nhap-mon-it`
                                );
                              }
                            }}
                          >
                            <img
                              className="CourseItem_thumb_img rounded-[16px] w-[228px] h-[142px]"
                              src="/image/courses/7.png"
                        ...
                        <div className="infor flex-1 ml-6">
                          <h2 className="text-[18px] font-bold m-0">
                            ...
                            >
                              ...
                              <span className="text-[#f05123] block text-[16px] font-semibold mt-[2px]">
                                Miễn phí
                              </span>
                            </div>
                          </h2>
                          ...
                          <p className="break-words text-[14px] my-2 mx-0 overflow-hidden leading-[20px]">
                            Để có cái nhìn tổng quan về ngành IT - Lập trình web
                            các bạn nên xem các videos tại khóa này trước nhé.
                          </p>
                          <div
                            className="Button_btn bg-[#f05123] text-[#fff] appearance-none border border-solid border-[#f05123] rounded-[999px] inline-block text-[14px] font-semibold text-center whitespace-nowrap select-none py-[8px] px-[20px] opacity-100 hover:opacity-95"
                            onClick={() => {
                              if (idCourseLearned?.includes(5)) {
                                return navigate(
                                  `/learning/kien-thuc-nhap-mon-it?id=1`
                ...
                <div>
                  <div>
                    <div className="border-[2px] border-solid border-[#e8e8e8] rounded-[16px] my-4 mx-0 p-6">
                      <div className="CourseItem_inner flex flex-wrap">
                        <div className="min-w-[228px] relative">
                          <Link to="">
                            <img
                              className="CourseItem_thumb_img rounded-[16px] w-[228px] h-[142px]"
                              src="/image/courses/62f13d2424a47.png"
                              alt="Kiến Thức Nhập Môn IT"
                            />
                          </Link>
                        </div>
                        <div className="infor flex-1 ml-6">
                          <h2 className="text-[18px] font-bold m-0">
                            <Link className="text-[#333] " to="">
                              HTML CSS Pro
                              <span className="text-[#f05123] block text-[16px] font-semibold mt-[2px]">
                                <span className="line-through text-black-color">
                                  {" "}
                                  2.500.000đ 
                                </span>
                                {" "}
                      ...
                      <div>
                        <h3 className="flex text-[14px] mt-6 font-semibold">
                          Khóa học liên quan
                        </h3>
                        <div className="ml-5">
                          <div>
                            <div className="RelatedCourses_inner flex flex-row rounded-[16px] gap-[20px] pt-5 pr-5 pb-0 pl-0">
                              <Link to="">
                                <div className="min-w-[126px] pt-[56%] relative">
                                  <img
                                    className="img-htmlcsspro rounded-[10px] h-[100%] inset-0 object-cover absolute w-[100%]"
                                    src="/image/courses/2.png"
                              ...
                              <div className="RelatedCourses_inner__HqcPw flex flex-wrap">
                                <h2 className="RelatedCourses_title text-[14px] font-bold m-0">
                                  <Link className="text-[#333]" to="">
                                    ...
                                    <span className="text-[#f05123] block text-[12px] font-semibold mt-[1px]">
                                      Miễn phí
                                    </span>
                                  </Link>
                                </h2>
                                ...
                                <p className="RelatedCourses_desc break-words text-[12px] leading-[14px] my-2 mx-0 overflow-hidden">
                                  Trong khóa này chúng ta sẽ cùng nhau xây dựng
                      ...
                      <div className="CourseItem_inner flex flex-wrap">
                        <div className="min-w-[228px] relative">
                          <Link to="">
                            <img
                              className="CourseItem_thumb_img rounded-[16px] w-[228px] h-[142px]"
                              src="/image/courses/624faac11d109.png"
                              alt="Kiến Thức Nhập Môn IT"
                            />
                          </Link>
                        </div>
              ...
              <div>
                <h2 className="text-[#333] text-[24px] font-black mt-[38px]">
                      ...
                      <div className="ProCourses_inner rounded-[16px] flex flex-col mb-[30px]">
                        <Link to="">
                          <div className="h-[100%] pt-[56%] relative group">
                            <img
                              className="inset-0 object-cover absolute rounded-[16px] h-[100%] w-[100%]"
                              src="/image/courses/62f13d2424a47.png"
                              alt=""
                            />
                        ...
                        <div>
                          ...
                          <div>
                            <span className="text-[14px] mr-2 line-through">
                              2.500.000đ
                            </span>
                            <span className="text-[#f05123] text-[16px] font-semibold">
                              1.299.000đ
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="rounded-[16px] flex flex-col mb-[30px]">
                        <Link to="">
                          <div className="h-[100%] pt-[56%] relative group">
                            <img
                              className="inset-0 object-cover absolute rounded-[16px] h-[100%] w-[100%]"
                              src="/image/courses/64e184ee5d7a2.png"
                              alt=""
                            />
                            <div className="bg-[#0000004d] rounded-[8px] pt-0 pb-[3px] pl-[5px] pointer-events-none absolute top-[12px] left-[11px] w-[27px] z-[1]">
                              <FaCrown className="text-[#FFD43B] fa-solid fa-crown" />
                      ...
                      <div className="rounded-[16px] flex flex-col mb-[30px]">
                        <Link to="">
                          <div className="h-[100%] pt-[56%] relative group">
                            <img
                              className="inset-0 object-cover absolute rounded-[16px] h-[100%] w-[100%]"
                              src="/image/courses/62f13cb607b4b.png"
                              alt=""
                            />
                            <div className="bg-[#0000004d] rounded-[8px] pt-0 pb-[3px] pl-[5px] pointer-events-none absolute top-[12px] left-[11px] w-[27px] z-[1]">
                              <FaCrown className="text-[#FFD43B] fa-solid fa-crown" />
                      ...
                      <div className="rounded-[16px] flex flex-col mb-[30px]">
                        <Link to="">
                          <div className="h-[100%] pt-[56%] relative group">
                            <img
                              className="inset-0 object-cover absolute rounded-[16px] h-[100%] w-[100%]"
                              src="/image/courses/648020fc16597.png"
                              alt=""
                            />
                            <div className="bg-[#0000004d] rounded-[8px] pt-0 pb-[3px] pl-[5px] pointer-events-none absolute top-[12px] left-[11px] w-[27px] z-[1]">
                              <FaCrown className="text-[#FFD43B] fa-solid fa-crown" />
              ...
              <div className="sticky top-[80px] flex justify-end ">
                <div className="Banners_content flex flex-wrap flex-col max-w-[300px] pl-[2px]">
                  <Link className="mt-[32px]" to="">
                    <img
                      className="max-w-[100%] w-[100%] rounded-lg object-cover opacity-100 hover:opacity-80"
