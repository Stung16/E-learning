                  ...
                  <div className="mt-4 overflow-hidden">
                    ...
                    <div className="Videos_item">
                      <Link to="" className="flex-shrink-0">
                        <div className={`Videos_img bg-[url('/public/image/courses/624faac11d109.png')]`}></div>
                      </Link>
                      <div className="pl-5">
                        <h2 className="text-[20px] leading-[32px] mb-0">
                            <Link to="" className="text-[#292929]">
                            Làm việc với font chữ #2
                            </Link>
                        </h2>
                            <p className="text-[#757575] text-[14px] leading-[32px] mt-1">
                            <Link to="" className="text-[#666] font-medium">
                            Xem trên Youtube...
                            </Link>
                            </p>
                      </div>
