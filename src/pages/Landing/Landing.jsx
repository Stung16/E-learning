                ...
                <div className='relative flex items-center'>
                    ...
                    <nav className=' ml-[46px] block'>
                        <ul className='nav flex list-none'>
                            ...
                            <li>
                                <Link className='py-1 px-3 font-medium text-[#fff]' to="/"> Điểm khác biệt </Link>
                            </li>
                            <li>
                                <Link className='py-1 px-3 font-medium text-[#fff]' to="/"> Thông số kỹ thuật </Link>
                            </li>
                            <li>
                                <Link className='py-1 px-3 font-medium text-[#fff]' to="/"> Câu hỏi thường gặp </Link>
                            </li>
                            <li>
                                <Link className='py-1 px-3 font-medium text-[#fff]' to="/">Liên hệ</Link>
                            </li>
                        </ul>
                    </nav>
                    <div></div>
        ...
        <main className='hero overflow-hidden'>
            ...
            <div className='pt-[64px] px-0 text-center'>
                <div className='max-w-[calc(100%-48px)] w-[1248px] my-0 mx-auto'>
                    ...
                    và thử thách, mua một lần học mãi mãi, được
                        ...
                        <div className='inner'>
                            ...
                            *Ở đây chỉ bao gồm nội dung tiêu biểu.
                            <Link className='text-highlight' to="">
                              Xem đầy đủ nội dung khóa học</Link>.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='mt-[60px] py-16 px-0'>
                        ...
                        <div className='flex-1 '>
                            ...
                            <div className='features-column flex-1'>
                                <div className='content'>
                                    ...
                                    <img className='absolute top-[14%] left-[7%] w-[90%] translate-x-[-2/4] translate-y-[-2/4]' src="/image/landing/glow-new.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='max-w-[calc(100%-48px)] w-[1248px] my-0 mx-auto'>
                            ...
                            <ul className='feedback-list'>
                                <li className='feedback-item'>
                                    ...
                                    Kiến thức siêu đầy đủ, chi tiết (vì chi tiết quá nên đôi lúc các bạn cũng sẽ tự lướt qua
                                    mà không muốn xem ấy :v). Các features đi kèm cực kỳ xịn sò mà các trang như Udemy,
                                    Udacity không có
                                    </blockquote>
                                    <div className='flex items-center mt-8'>
                                        <img className='w-[40px] h-[40px] rounded-[50%] object-cover' src="/image/landing/feedback-1.jpg" alt="" />
                                        <div className='flex-1 ml-[10px]'>
                                            <span className='text-[20px] leading-[28px] block'>Nam Thanh</span>
                                            <span className='text-[14px] font-mono text-[#8b949e] leading-[28px] block'> Người học khóa HTML CSS Pro </span>
                                        </div> 
                                    </div>
                                </li>
                                <li className='feedback-item'>
                                    ...
                                    <div className='flex items-center mt-8'>
                                        <img className='w-[40px] h-[40px] rounded-[50%] object-cover' src="/image/landing/feedback-1.jpg" alt="" />
                                        <div className='flex-1 ml-[10px]'>
                                            <span className='text-[20px] leading-[28px] block'>Tuan Nguyen</span>
                                            <span className='text-[14px] font-mono text-[#8b949e] leading-[28px] block'> Người học khóa HTML CSS Pro </span>
                                        </div> 
                                    </div>
                                </li>
                                <li className='feedback-item'>
                                    ...
                                    <div className='flex items-center mt-8'>
                                        <img className='w-[40px] h-[40px] rounded-[50%] object-cover' src="/image/landing/feedback-1.jpg" alt="" />
                                        <div className='flex-1 ml-[10px]'>
                                            <span className='text-[20px] leading-[28px] block'>Ngọc Đoàn</span>
                                            <span className='text-[14px] font-mono text-[#8b949e] leading-[28px] block'> Người học khóa HTML CSS Pro </span>
                                        </div> 
                                    </div>
                                </li>
                                <li className='feedback-item'>
                                    ...
                                    <div className='flex items-center mt-8'>
                                        <img className='w-[40px] h-[40px] rounded-[50%] object-cover' src="/image/landing/feedback-1.jpg" alt="" />
                                        <div className='flex-1 ml-[10px]'>
                                            <span className='text-[20px] leading-[28px] block'>Khải Võ</span>
                                            <span className='text-[14px] font-mono text-[#8b949e] leading-[28px] block'> Người học khóa HTML CSS Pro </span>
                                        </div> 
                                    </div>
                                </li>
                    ...
                    <div className='specifications relative mt-[70px] py-16 px-0'>
                        <div className='max-w-[calc(100%-48px)] w-[1248px] my-0 mx-auto'>
                            ...
                            <h2 className='second-heading text-[42px] leading-[59px] font-bold text-[#fff]'>Thông số kỹ thuật</h2>
                                ...
                                <table className='w-[100%] mt-10 border-collapse border-spacing-0'>
                                    <tbody>
                                        ...
                                        <tr className='border-t border-b border-solid border-[#30363d]'>
                                            <td className='py-4 px-0 text-[20px] w-[340px]'>
                                            <b className='font-semibold text-[#fff]'>Chất lượng bài học video</b>
                                            </td>
                                            <td className='py-4 px-0 text-[20px]'>60 FPS / 480p, 720p, 1080p, 1440p</td>
                                        </tr>
                                        <tr className='border-t border-b border-solid border-[#30363d]'>
                                            <td className='py-4 px-0 text-[20px] w-[340px]'>
                                            <b className='font-semibold text-[#fff]'>Trải nghiệm trên di động</b>
                                            </td>
                                            <td className='py-4 px-0 text-[20px]'>Tương thích hoàn toàn</td>
                                        </tr>
                                        <tr className='border-t border-b border-solid border-[#30363d]'>
                                            <td className='py-4 px-0 text-[20px] w-[340px]'>
                                            <b className='font-semibold text-[#fff]'>Mạng phân phối nội dung</b>
                                            </td>
                                            <td className='py-4 px-0 text-[20px]'>Tốc độ cao, trong nước và quốc tế</td>
                                        </tr>
                                        <tr className='border-t border-b border-solid border-[#30363d]'>
                                            <td className='py-4 px-0 text-[20px] w-[340px]'>
                                            <b className='font-semibold text-[#fff]'>Hỗ trợ giao diện sáng / tối</b>
                                            </td>
                                            <td className='py-4 px-0 text-[20px]'>Có</td>
                                        </tr>
                                        <tr className='border-t border-b border-solid border-[#30363d]'>
                                            <td className='py-4 px-0 text-[20px] w-[340px]'>
                                            <b className='font-semibold text-[#fff]'>Giải thích thuật ngữ ngành</b>
                                            </td>
                                            <td className='py-4 px-0 text-[20px]'>Có</td>
                                        </tr>
                                        <tr className='border-t border-b border-solid border-[#30363d]'>
                                            <td className='py-4 px-0 text-[20px] w-[340px]'>
                                            <b className='font-semibold text-[#fff]'>Hỗ trợ sử dụng phím tắt</b>
                                            </td>
                                            <td className='py-4 px-0 text-[20px]'>Có</td>
                                        </tr>
                                        <tr className='border-t border-b border-solid border-[#30363d]'>
                                            <td className='py-4 px-0 text-[20px] w-[340px]'>
                                            <b className='font-semibold text-[#fff]'>Các loại nội dung học</b>
                                            </td>
                                            <td className='py-4 px-0 text-[20px]'>Bài học video, kiểm tra, thử thách, flashcards, games, v.v</td>
                                        </tr>
                                        <tr className='border-t border-b border-solid border-[#30363d]'>
                                            <td className='py-4 px-0 text-[20px] w-[340px]'>
                                            <b className='font-semibold text-[#fff]'>Nhiều tính năng khác</b>
                                            </td>
                            ...
                            <img className='absolute top-[9%] left-[3%] w-[100%] max-w-[1300px] translate-x-[-1/2] translate-y-[-1/2]' src="/image/landing/glow-new.png" alt="" />
                        </div>
                    </div>
                    {/* CDN */}
